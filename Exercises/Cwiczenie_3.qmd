...
Po zmniejszeniu danych wejściowych otrzymujemy pole pod krzywą ROC 0.931 i dokładność klasyfikacji 0.885.
...
Wnioski:
Zastosowanie metod resamplingu przy użyciu większego nakładu mocy obliczeniowej minimalnie polepszyło nam wydajność modelu. Jeżeli bardzo nam zależy na wydajności, warto jest przeprowadzić resampling, bądź też zmienić model.Na wykresie widać, że nie zawsze próbkowanie musi mieć pozytywne skutki
